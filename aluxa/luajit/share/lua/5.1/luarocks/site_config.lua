local site_config = {}
site_config.LUAROCKS_PREFIX=[[/usr/local/aluxa/luajit]]
site_config.LUA_INCDIR=[[/usr/local/aluxa/luajit/include/luajit-2.1]]
site_config.LUA_LIBDIR=[[/usr/local/aluxa/luajit/lib]]
site_config.LUA_BINDIR=[[/usr/local/aluxa/luajit/bin]]
site_config.LUA_INTERPRETER=[[luajit]]
site_config.LUAROCKS_SYSCONFDIR=[[/usr/local/aluxa/luajit/etc/luarocks]]
site_config.LUAROCKS_ROCKS_TREE=[[/usr/local/aluxa/luajit]]
